...
ComposerEditorWebEnginePrivate::ComposerEditorWebEnginePrivate(ComposerEditorWebEngine::ComposerWebEngine *qq)
    : action_text_bold(nullptr),
      ...
      action_ordered_list(nullptr),
      action_unordered_list(nullptr),
      action_format_type(nullptr),
      action_font_size(nullptr),
      action_font_family(nullptr),
      action_add_emoticon(nullptr),
      action_insert_html(nullptr),
      action_insert_image(nullptr),
      action_insert_table(nullptr),
      action_text_foreground_color(nullptr),
      action_text_background_color(nullptr),
      action_format_reset(nullptr),
      action_insert_link(nullptr),
      action_spell_check(nullptr),
      action_find(nullptr),
      action_replace(nullptr),
      action_page_color(nullptr),
      action_block_quote(nullptr),
      action_save_as(nullptr),
      action_print(nullptr),
      action_print_preview(nullptr),
      action_paste_withoutformatting(nullptr),
      action_insert_specialchar(nullptr),
      action_insert_anchor(nullptr),
      q(qq),
      //imageResizeWidget(nullptr),
      mPageEngine(nullptr)
{
}
